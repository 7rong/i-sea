          ...
          <div class="row">
            <div class="col-sm-4">
              ...
              <div class="mb-3">
                ...
                <input type="file" id="customFile" class="form-control"></label>
              </div>
            ...
            <div class="col-sm-8">
              ...
              <div class="mb-3">
                ...
                v-model="tempProduct.description"></textarea></label>
              </div>
              <div class="mb-3">
                <label for="content" class="form-label">說明內容
                <textarea type="text" class="form-control"
                id="content" placeholder="請輸入產品說明內容"
                v-model="tempProduct.content"></textarea></label>
              </div>
              <div class="mb-3">
